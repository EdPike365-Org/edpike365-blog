  ...
  return (
    <Layout>
      <div>
        ...
        <p>This Privacy Policy is prepared by EdPike365 and whose registered address is 1915 SE 34th Ave, Portland, Oregon USA, 97214 (“We”) are committed to protecting and preserving the privacy of our visitors when visiting our site or communicating electronically with us.</p>
        <p>This policy sets out how we process any personal data we collect from you or that you provide to us through our website and social media sites. We confirm that we will keep your information secure and comply fully with all applicable United States of America Data Protection legislation and regulations. Please read the following carefully to understand what happens to personal data that you choose to provide to us, or that we collect from you when you visit our sites. By submitting information you are accepting and consenting to the practices described in this policy.</p>
        ...
        <h2>Contact</h2>
        <p>Questions, comments, and requests regarding this privacy policy are welcomed and should be addressed to policy@edpike365.com.</p>
        <br />
        <hr/>
        <br />

        <h2>How to Delete Your Data From EdPike365.com:</h2>
        <p>Use the <Link to="/contact">contact form</Link> to request that your account, and the data in it, be removed from EdPike365.com. An automatic "delete my account" button is on our TODO list.</p>
        <h3>How to delete social connections from:</h3>
        <ul>
          <li><strong>Facebook</strong><br />
            Facebook users can delete their Facebook data integration from EdPike365 by following the "Remove an app or game you've added" instructions on:
            <a href="https://www.facebook.com/help/942196655898243?helpref=hc_fnav" target="_blank" rel="noreferrer" >Facebook's Manage Your Apps page</a>.</li>
        </ul>
        <br />
        <br />
        <br />
        <h4>Under Construction: International Privacy Policy</h4>
        <a href="https://app.termly.io/dashboard/website/0aff8fef-6e0d-4961-a6cd-d1e9c6a401fc/privacy-policy" target="_blank" rel="noreferrer" >International Privacy Policy</a>
        <br />
      </div>
    </Layout>
  )
