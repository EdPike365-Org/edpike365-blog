  ...
  return (
    <Layout>
      <div>
        ...
        <p>
          This Privacy Policy is prepared by EdPike365 and whose registered
          address is 1915 SE 34th Ave, Portland, Oregon USA, 97214 (“We”) are
        ...
        <p>
          ...
          fully with all applicable United States of America Data Protection
          ...
          us, or that we collect from you when you visit our sites. By
        ...
        <p>
          ...
          policy@edpike365.com. We will provide your personal data to you within
          the statutory time frames. To enable us to trace any of your personal
          data that we may be holding, we may need to request further
        ...
        <p>
          ...
          welcomed and should be addressed to policy@edpike365.com.
        </p>
        <br />
        <hr />
        <br />
        ...
        <p>
          Use the <Link to="/contact">contact form</Link> to request that your
          account, and the data in it, be removed from EdPike365.com. An
          automatic "delete my account" button is on our TODO list.
        </p>
        ...
        <ul>
          <li>
            ...
            <br />
            Facebook users can delete their Facebook data integration from
            EdPike365 by following the "Remove an app or game you've added"
            instructions on:
            <a
              href="https://www.facebook.com/help/942196655898243?helpref=hc_fnav"
              target="_blank"
              rel="noreferrer"
            >
              Facebook's Manage Your Apps page
            </a>
            .
          </li>
        </ul>
        ...
        <a
          href="https://app.termly.io/dashboard/website/0aff8fef-6e0d-4961-a6cd-d1e9c6a401fc/privacy-policy"
          target="_blank"
          rel="noreferrer"
        >
