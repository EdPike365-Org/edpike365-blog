...
// from https://fontawesome.com/icons/bell?style=regular
...
const HollowBellIcon = props => {
  return (
    <BellSpan fontHeight={props.fontHeight}>
      <svg
        aria-hidden="true"
        focusable="false"
        data-prefix="far"
        ...
        viewBox="0 0 448 512"
        className="svg-inline--fa fa-bell fa-w-14 fa-2x"
      >
        <path
          fill="currentColor"
